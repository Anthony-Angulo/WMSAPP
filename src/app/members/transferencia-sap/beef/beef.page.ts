        ...
        if (codFound < 0) {
          ...
          if (this.productData.detalle_codigo[codFound].UOM_id != 3) {
            ...
            if (peso != '.') {
              ...
              let ind = this.detail.findIndex(product => product.code == this.codigoBarra)
              let findBatch = this.batch.find
          ...
          //       quantity: Number(Number(this.productData.NumPerMsr).toFixed(2))
          //     })
          //     this.cantidadEscaneada++
